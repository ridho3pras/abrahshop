												...
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="text-center">
                                                            <a href="editkategori.php?id_kategori=<?php echo $p['idkategori'] ?>;" > <i class="fa fa-edit"> &nbsp; &nbsp;</i></a>
                                                            <a href="hapuskategori.php?id_kategori=<?php echo $p['idkategori'] ?>;" onclick="javascript: return confirm('Anda yakin ingin menghapus <?php echo $p['namakategori'] ?> ?')"><i class="fa fa-trash"></i></a>
                                                        </div>
