												...
												<tr>
													...
													<td>
                                                        <div class="text-center">
                                                            <a href="editproduk.php?id_produk=<?php echo $p['idproduk'] ?>;" > <i class="fa fa-edit">&nbsp; &nbsp;</i></a>
                                                            <a href="hapusproduk.php?id_produk=<?php echo $p['idproduk'] ?>;" onclick="javascript: return confirm('Anda yakin ingin menghapus <?php echo $p['namaproduk'] ?> ?')"><i class="fa fa-trash"></i></a>
                                                        </div>
					...
					<div class="modal-content">
						...
						<form action="produk.php" method="post" enctype="multipart/form-data" >
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="deskripsi" placeholder="" required></textarea>
								</div>
								<div class="form-group">
