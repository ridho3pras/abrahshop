<?php 
	...
	$itungorder = mysqli_query($conn,"select count(idproduk) as jumlahproduk from produk");
	$itungorder2 = mysqli_fetch_assoc($itungorder);
	$itungorder3 = $itungorder2['jumlahproduk'];
	
	$itungtrans = mysqli_query($conn,"select count(id) as jumlahpesan from contact");
	$itungtrans2 = mysqli_fetch_assoc($itungtrans);
	$itungtrans3 = $itungtrans2['jumlahpesan'];
						...
						<div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Pesan Masuk</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
