...
<html>
<head>
<title>Abrahshop - Favorit Saya</title>
<!-- for-mobile-apps -->
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h2>Dalam favorit ada : <span><?php echo $itungtrans3 ?> barang</span></h2>
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						<td class="invert"><a href="product.php?idproduk=<?php echo $b['idproduk'] ?>"></a> <img src="<?php echo $b['gambar'] ?>" width="100px" height="100px" /></td>
						<td class="invert"><a href="product.php?idproduk=<?php echo $b['idproduk'] ?>"><?php echo $b['namaproduk'] ?></a></td>
