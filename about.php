		...
		<div class="container">
			...
			<div class="col-md-2">  </div>
				<div class="col-md-8 about-wthree-grids grid-top">
					<h4 class="text-center">Abrahshop adalah jasa titip beli barang dari Yogyakarta.</h4>
					<p class="top text-justify">
					Disini kami menawarkan jasa titip beli barang yang ada di Jogja yang kemudian akan kami kirim kepada Pelanggan tercinta.
					Anda bisa request barang yang ingin Anda beli kepada admin kami dengan catatan barang tersebut dijual di daerah Yogyakarta.
					Kami akan memberikan layanan terbaik dan juga tercepat kepada Anda. 
					<br>
					</p>
