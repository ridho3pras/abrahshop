...
<html>
<head>
<title>Abrahshop - Pencarian</title>
<!-- for-mobile-apps -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>BINGUNG MAU NITIP BELI BARANG DARI LUAR KOTA? DI ABRAHSHOP AJA!</p>
			</div>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="konfirmasi.php">Cara Pemesanan</a></li>
								</ul>
							</div>
							</nav>
			</div>
									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"> </a>		
												<img title=" " alt=" " src="<?php echo $p['gambar']?>" width="200px" height="200px"  style="display:block; margin:auto;" /> 	
