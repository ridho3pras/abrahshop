		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-6 agileinfo_single_left">
					<img id="example" src="<?php echo $p['gambar']?>" alt=" " class="img-responsive"  style="display:block; margin:auto;" >
				</div>
					...
					<div class="snipcart-item block">
						...
						<div >
							<form action="#" method="post">
								<fieldset>
								<button type="button" class="btn btn-success"><a style="color:white;" href="https://api.whatsapp.com/send?phone=<?php echo $record['no_hp']?>" style="color: black;" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i> PESAN</a></button>
									<input type="hidden" name="idprod" value="<?php echo $idproduk ?>">
									<input type="submit" name="addprod" value="Add Favorit" class="btn btn-danger">
								</fieldset>
							</form>
						</div>
